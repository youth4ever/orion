...
if __name__ == "__main__": main()   # that prevents the main code from being run when it's imported as a module
                                    # More exactly it prevents the functions being run, it imports only the classes
                                    # with their corresponding methods
                                    # In this case the "def test()" function is prevented to run when imported in
                                    # some other script/module
