...
bog=CFraction(Decimal(41).sqrt(),40)
print("Here we list the continued terms (the a's )  : \n", bog)
print('\n In terms of the fractions: ',bog.fraction(2),'\n')

for i in range(1, 10):
    print(bog.fraction(i), end='   ')