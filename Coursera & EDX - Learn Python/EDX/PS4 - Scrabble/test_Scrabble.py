...
#     #for k, v in SCRABBLE_LETTER_VALUES.items() :
#     S += SCRABBLE_LETTER_VALUES[str(i)]
#     #print(SCRABBLE_LETTER_VALUES[str(i)],  end=' ;   ')
# print(S)
...
#print('Random characters :      ',dealHand(5))
...
# word = 'quails'
# for i in word :
#     if handd.get(str(i)) != None :
#         #print(i,  handd.get(str(i)), end=' ->   ')
#         handd[str(i)] = handd.get(str(i)) -1
#
...
# print(val, min(val))
#
# if len(val) > 0 and min(val) >= 0 : print('Yes')
# else : print('No')

# for k, v in hand.items():     print(k, end= ' ;   ')
...
#print(isValidWord('rapture', hand, wordList))
...
# hand = {'h': 1, 'y': 1, 't': 2, 'c': 2, 'o': 2, 'u': 2, 'a': 1, 'z': 1}
# word = 'chayote'
# displayHand(hand)
#
# print(word)
...
# a = updateHand(hand,'himaczm')
# print(a)
# print(a.keys())
# print(a.values())
# print([x for x in a.values() if x >0])
# print(list(a))
